...
⚠️ Сложный, редко нужен
	...
	6. VersionedCollapsingMergeTree - то же самое, что предыдущий, но с версией и решает конфликты порядка
...
👉 В проде почти всегда Replicated*.
	...
	9. Distributed - это НЕ хранение и не локальные таблицы, это:
